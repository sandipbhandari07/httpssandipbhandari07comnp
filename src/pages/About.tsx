...
import { Github, Linkedin, Music, Play } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <main className="h-screen flex items-center px-6 md:px-12 pt-20 pb-8">
        <div className="max-w-[1400px] mx-auto w-full grid lg:grid-cols-[1fr_320px] gap-6 animate-fade-in">
          {/* Left: Profile + Code blocks */}
          <div className="flex flex-col gap-5 justify-center">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-terminal-green to-terminal-purple bg-clip-text text-transparent">
                  Sandip Bhandari
                </h1>
                <p className="text-sm font-mono text-terminal-purple mt-1">Android & API Dev</p>
                <div className="flex gap-2 mt-3">
                  <a href="https://github.com/sandipbhandari07" target="_blank" rel="noopener noreferrer"
                    className="w-8 h-8 rounded-lg bg-secondary/50 border border-border/50 flex items-center justify-center hover:bg-terminal-green/20 hover:border-terminal-green/50 hover:text-terminal-green transition-all">
                    <Github className="w-4 h-4" />
                  </a>
                  <a href="https://www.linkedin.com/in/sandipbhandari07/" target="_blank" rel="noopener noreferrer"
                    className="w-8 h-8 rounded-lg bg-secondary/50 border border-border/50 flex items-center justify-center hover:bg-terminal-purple/20 hover:border-terminal-purple/50 hover:text-terminal-purple transition-all">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="relative">
                ...
                <DartCodeBlock code={aboutCode} fileName="about_me.dart" className="relative" />
              </div>
              <div className="relative">
                <div className="absolute -inset-1 rounded-2xl bg-gradient-to-br from-terminal-purple to-terminal-green opacity-15 blur-xl" />
                <DartCodeBlock code={skillsCode} fileName="my_skills.dart" className="relative" />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="relative">
              <div className="absolute -inset-[1px] rounded-2xl bg-gradient-to-b from-[hsl(142,76%,36%)] to-terminal-purple opacity-30 blur-sm" />
                  ...
                  {spotifyPlaylists.map(playlist => (
                    <a key={playlist.id} href="https://open.spotify.com/user/l74zqsnogdrcza7mxoean84gk" target="_blank" rel="noopener noreferrer"
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-sm font-medium truncate group-hover/item:text-[hsl(142,76%,36%)] transition-colors">{playlist.name}</h3>
